...
=>for more information you can take help from youtube 
----------------------------------------------------
----------------------------------------------------
//////////////Four Step////////////////////////////
----------------------------------------------------
...
for login into User,Owner,Admin goto brm.db database
and check user_data,owner,admin_login for user name and password or open project login info and table.docs file 
