...
root = Tk()
root.title("Election 2023")
root.geometry("1295x745")
f = Frame(root, height=745, width=1295, bg="white")
f.pack()

lb = Label(f, text="Election 2023", width=50, height=1, font=("Helvetica", 36, "bold italic"), fg="black", bg="gold")
lb.place(x=0, y=0)
...
def buttonClickadmin(self):
    ...
    def buttonClicklogin(self):
        ...
        if (flag == 0):
            ...
            lhead2 = Label(finfo, text="CNIC", font=("", 12, ""), bg="white", fg="black")
            ...
            def buttonClickstats(self):
                ...
                bexit = Button(fstats, text="BACK", width=5, height=1, font=("", 16, ""), bg="gold", fg="black",
                               activeforeground="white", activebackground="grey")
                bexit.place(x=600, y=650)
                bexit.bind('<Button-1>', buttonClickexit)

            bstats = Button(finfo, text="STATS", width=5, height=1, font=("", 16, ""), bg="gold", fg="black",
                            activeforeground="white", activebackground="grey")
            ...
            bback = Button(finfo, text="LOGOUT", width=7, height=1, font=("", 16, ""), bg="gold", fg="black",
                           activeforeground="white", activebackground="grey")
            bback.place(x=640, y=650)
            bback.bind('<Button-1>', buttonClickback)

    blogin = Button(fadmin, text="LOGIN", width=5, height=1, font=("", 16, ""), bg="gold", fg="black",
                    activeforeground="white", activebackground="grey")
    blogin.place(x=200, y=280)
    blogin.bind('<Button-1>', buttonClicklogin)


badmin = Button(f, text="ADMIN", width=8, height=2, font=("", 16, ""), bg="gold", fg="black", activeforeground="white",
...
def buttonClickuser(self):
    ...
    lbadh = Label(fuser, text="CNIC no. : ", height=1, font=("", 22, ""), bg="white", fg="black")
    ...
    def buttonClicksub(self):
        ...
        if (check == 0):
            ...
            lb = Label(fvote, text="Election 2023", width=50, height=1, font=("Helvetica", 36, "bold italic"),
                       fg="black", bg="gold")
            lb.place(x=0, y=0)

            lbtitle = Label(fvote, text="Candidate List", height=1, font=("", 22, "bold underline"), bg="white",
                            fg="black")
            ...
            def buttonClickcast(self):
                ...
                cur.execute("Insert into results (name,adh,age,gender,vote) Values(%s,%s,%s,%s,%s)",
                            (name, adh, age, gender, vote))
                cur.execute("commit;")
            ...
            bcast = Button(fvote, text="SUBMIT", width=5, height=1, font=("", 16, ""), bg="gold", fg="black",
                           activeforeground="white", activebackground="grey")
            bcast.place(x=600, y=650)
            bcast.bind('<Button-1>', buttonClickcast)

    bsub = Button(fuser, text="SUBMIT", width=5, height=1, font=("", 16, ""), bg="gold", fg="black",
                  activeforeground="white", activebackground="grey")
    bsub.place(x=200, y=320)
    bsub.bind('<Button-1>', buttonClicksub)


buser = Button(f, text="VOTER", width=8, height=2, font=("", 16, ""), bg="gold", fg="black", activeforeground="white",
               activebackground="grey")
