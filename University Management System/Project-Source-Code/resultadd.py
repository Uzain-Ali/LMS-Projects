...
def add():
    ...
    if (studid == "" or studid == " ") or (fname == "" or fname == " ") or (lname == "" or lname == " ") or (
            address == "" or address == " ") or (phone == "" or phone == " "):
...
label = Label(root, text="Student Result Adding System ", font=('Arial Bold', 30))
label.grid(row=0, column=0, columnspan=8, rowspan=2, padx=50, pady=40)

studidLabel = Label(root, text="Studdent ID", font=('Arial', 15))
fnameLabel = Label(root, text="Year", font=('Arial', 15))
lnameLabel = Label(root, text="Semester", font=('Arial', 15))
addressLabel = Label(root, text="Grede", font=('Arial', 15))
phoneLabel = Label(root, text="Cgpa", font=('Arial', 15))
...
resetBtn = Button(
    ...
    bd=5, font=('Arial', 15), bg="#F398FF", command=Back)
selectBtn = Button(
...
my_tree['columns'] = ("Student ID", "Year", "Semester", "Grede", "CGPA")

my_tree.column("#0", width=0, stretch=NO)
my_tree.column("Student ID", anchor=W, width=170)
my_tree.column("Year", anchor=W, width=150)
my_tree.column("Semester", anchor=W, width=150)
my_tree.column("Grede", anchor=W, width=165)
my_tree.column("CGPA", anchor=W, width=150)

my_tree.heading("Student ID", text="Student ID", anchor=W)
my_tree.heading("Year", text="Year", anchor=W)
my_tree.heading("Semester", text="Semester", anchor=W)
my_tree.heading("Grede", text="Grede", anchor=W)
my_tree.heading("CGPA", text="CGPA", anchor=W)
