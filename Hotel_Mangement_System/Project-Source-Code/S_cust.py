...
def add_data():
    if var_mobile.get() == "" or var_nm.get() == "":
        ...
        try:
            ...
            conn = mysql.connector.connect(host="localhost", username="root", password="uzain", database="hotel")
            my_cursor = conn.cursor()
...
combo_nationality["value"] = ("Bangladeshi", "Indian", "American", "British","Pakistani")
