...
Label(r, text="Enter Reg Number",font="Times 14 bold",bg="#9993B6").place(x=480,y=50)
global e1
e1=Entry(r,font="Times 18 bold",bg="gray",fg="white")
e1.place(x=650,y=50)
...
def ok():
    ...
    for ro in conn:
        ...
        ro[0], ro[1], ro[2], ro[3], ro[4], ro[5], ro[6], ro[7], ro[8], ro[9], ro[10], ro[11], ro[12], ro[13], ro[14]))
        i = i + 1
    e1.delete(0, END)

Button(r,text="search",command=ok,height=2,width=10,font="Times 14 bold").place(x=900,y=40)

def log_out():
    r.destroy()
    call(["python", "main.py"])

Button(r,text="Log Out",command=log_out,height=2,width=7,font="Times 14 bold").place(x=1420,y=5)
...
Button(r,text="Back",command=back,height=2,width=7,font="Times 14 bold").place(x=5,y=5)
