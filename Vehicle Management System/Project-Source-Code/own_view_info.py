...
Label(r, text="Enter Reg Number", font="Times 12 bold", bg="#456179").place(x=500, y=250)
global e1
...
Button(r, text="Log Out", command=log_out, height=2, width=7,  font="Times 12 bold").place(x=1425, y=5)
