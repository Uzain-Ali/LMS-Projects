...
def connectdb():
    ...
    con = p.connect(host="localhost", user="root", passwd="uzain", db="library1")
    cur = con.cursor()
...
def home():
        ...
        canvas.pack()
        label = Label(window, text="Welcome To Ghalib Library", height=3, width=60, font="Bold",
                      bg="yellow", fg="indigo")
        label.pack()
